(function(e, t, n) {
    L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        addLayer: function(e) {
            ...
            var r = e,
                i = this._map.getZoom();
            if (e.__parent) {
                while (r.__parent._zoom >= i) {
                    r = r.__parent
                }
            }
            if (this._currentShownBounds.contains(r.getLatLng())) {
                if (this.options.animateAddingMarkers) {
                    this._animationAddLayer(e, r)
                } else {
                    this._animationAddLayerNonAnimated(e, r)
                }
            }
            return this
        },
        ...
        addLayers: function(e) {
            ...
            if (this._map) {
                ...
                var h = L.bind(function() {
                    ...
                    if (s) {
                        s(l, e.length, (new Date).getTime() - c)
                    }
                    if (l === e.length) {
                        ...
                        setTimeout(h, this.options.chunkDelay)
                    }
                }, this);
                h()
            } else {
        ...
        removeLayers: function(e) {
            ...
            if (!this._map) {
                for (t = 0, n = e.length; t < n; t++) {
                    r = e[t];
                    this._arraySplice(this._needsClustering, r);
                    s.removeLayer(r)
                }
                return this
            }
        ...
        zoomToShowLayer: function(e, t) {
            var n = function() {
                if ((e._icon || e.__parent._icon) && !this._inZoomAnimation) {
                    ...
                    if (e._icon) {
                        ...
                        var r = function() {
                            this.off("spiderfied", r, this);
                            t()
                        };
                        this.on("spiderfied", r, this);
                        e.__parent.spiderfy()
                    }
                }
            };
            if (e._icon && this._map.getBounds().contains(e.getLatLng())) {
                ...
                this._map.setView(e.getLatLng(), e.__parent._zoom + 1);
        ...
        onAdd: function(e) {
            ...
            this._featureGroup.onAdd(e);
            this._nonPointGroup.onAdd(e);
            if (!this._gridClusters) {
                this._generateInitialClusters()
            }
            for (t = 0, n = this._needsRemoving.length; t < n; t++) {
                r = this._needsRemoving[t];
                this._removeLayer(r, true)
            }
            this._needsRemoving = [];
        ...
        onRemove: function(e) {
            ...
            this._hideCoverage();
            this._featureGroup.onRemove(e);
            this._nonPointGroup.onRemove(e);
            this._featureGroup.clearLayers();
            this._map = null
        },
        ...
        _removeLayer: function(e, t, n) {
            var r = this._gridClusters,
                ...
                o = this._map;
            if (t) {
                for (var u = this._maxZoom; u >= 0; u--) {
                    if (!i[u].removeObject(e, o.project(e.getLatLng(), u))) {
                        break
                    }
                }
            }
            var a = e.__parent,
                f = a._markers,
                l;
            this._arraySplice(f, e);
            while (a) {
                a._childCount--;
                if (a._zoom < 0) {
                    break
                } else if (t && a._childCount <= 1) {
                    l = a._markers[0] === e ? a._markers[1] : a._markers[0];
                    r[a._zoom].removeObject(a, o.project(a._cLatLng, a._zoom));
                    i[a._zoom].addObject(l, o.project(l.getLatLng(), a._zoom));
                    this._arraySplice(a.__parent._childClusters, a);
                    a.__parent._markers.push(l);
                    l.__parent = a.__parent;
                    if (a._icon) {
                        s.removeLayer(a);
                        if (!n) {
                            s.addLayer(l)
        ...
        _moveEnd: function() {
            ...
            this._topClusterLevel._recursivelyAddChildrenToMap(null, this._map._zoom, e);
        ...
        _addLayer: function(e, t) {
            ...
            if (this.options.singleMarkerMode) {
                e.options.icon = this.options.iconCreateFunction({
            ...
            for (; t >= 0; t--) {
                ...
                if (o) {
                    var u = o.__parent;
                    if (u) {
                        this._removeLayer(o, false)
                    }
                    var a = new L.MarkerCluster(this, t, o, e);
                    n[t].addObject(a, this._map.project(a._cLatLng, t));
                    o.__parent = a;
                    e.__parent = a;
                    var f = a;
                    for (s = t - 1; s > u._zoom; s--) {
                        f = new L.MarkerCluster(this, s, f);
                        n[s].addObject(f, this._map.project(o.getLatLng(), s))
                    }
                    u._addChild(f);
                    for (s = t; s >= 0; s--) {
                        if (!r[s].removeObject(o, this._map.project(o.getLatLng(), s))) {
                            break
                        }
                    }
                    return
        ...
        _mergeSplitClusters: function() {
            this._processQueue();
            if (this._zoom < this._map._zoom && this._currentShownBounds.contains(this._getExpandedVisibleBounds())) {
        ...
        _getExpandedVisibleBounds: function() {
            ...
            var e = this._map,
                ...
                n = t._southWest,
                r = t._northEast,
                i = L.Browser.mobile ? 0 : Math.abs(n.lat - r.lat),
                s = L.Browser.mobile ? 0 : Math.abs(n.lng - r.lng);
            return new L.LatLngBounds(new L.LatLng(n.lat - i, n.lng - s, true), new L.LatLng(r.lat + i, r.lng + s, true))
        },
    ...
    L.MarkerClusterGroup.include(!L.DomUtil.TRANSITION ? {
        ...
        _animationZoomIn: function(e, t) {
            ...
            this._topClusterLevel._recursively(n, e, 0, function(s) {
                ...
                if (s._isSingleParent() && e + 1 === t) {
                    ...
                    s.setOpacity(0);
                    s._recursivelyAddChildrenToMap(o, t, n)
                }
        ...
        _animationZoomOutSingle: function(e, t, n) {
            ...
            var i = this;
            this._forceLayout();
            e._recursivelyBecomeVisible(r, n);
            this._enqueue(function() {
                if (e._childCount === 1) {
                    var s = e._markers[0];
        ...
        _animationAddLayer: function(e, t) {
            ...
            if (t !== e) {
                if (t._childCount > 2) {
                    ...
                    this._forceLayout();
                    n._animationStart();
                    n._animationZoomOutSingle(t, this._map.getMaxZoom(), this._map.getZoom())
                }
            }
        },
    ...
    L.MarkerCluster = L.Marker.extend({
        ...
        zoomToBounds: function() {
            ...
            if (n > r) {
                ...
                this._group._map.setView(this._latlng, i + 1)
            } else {
        ...
        _expandBounds: function(e) {
            ...
            if (e instanceof L.MarkerCluster) {
                ...
                this._cLatLng = e._cLatLng || n
            }
            var r = this._childCount + t;
            if (!this._wLatLng) {
                this._latlng = this._wLatLng = new L.LatLng(n.lat, n.lng)
            } else {
                this._wLatLng.lat = (n.lat * t + this._wLatLng.lat * this._childCount) / r;
                this._wLatLng.lng = (n.lng * t + this._wLatLng.lng * this._childCount) / r
            }
        },
        ...
        _recursivelyAnimateChildrenInAndAddSelfToMap: function(e, t, n) {
            this._recursively(e, n, 0, function(r) {
                r._recursivelyAnimateChildrenIn(e, r._group._map.latLngToLayerPoint(r.getLatLng()).round(), t);
                if (r._isSingleParent() && t - 1 === n) {
                    r.setOpacity(1);
                    r._recursivelyRemoveChildrenFromMap(e, t)
                } else {
                    r.setOpacity(0)
                }
                r._addToMap()
        ...
        _recursivelyAddChildrenToMap: function(e, t, n) {
            this._recursively(n, -1, t, function(r) {
                ...
                for (var i = r._markers.length - 1; i >= 0; i--) {
                    ...
                    r._group._featureGroup.addLayer(s)
                }
            }, function(t) {
                t._addToMap(e)
            })
        ...
        _recursivelyRestoreChildPositions: function(e) {
            ...
            if (e - 1 === this._zoom) {
                ...
                for (var i = this._childClusters.length - 1; i >= 0; i--) {
                    this._childClusters[i]._recursivelyRestoreChildPositions(e)
                }
            }
        },
        ...
        _recursively: function(e, t, n, r, i) {
            ...
            if (t > o) {
                for (u = s.length - 1; u >= 0; u--) {
                    a = s[u];
                    if (e.intersects(a._bounds)) {
                        a._recursively(e, t, n, r, i)
                    }
                }
            } else {
                if (r) {
        ...
        _recalculateBounds: function() {
            ...
            for (n = e.length - 1; n >= 0; n--) {
                this._expandBounds(e[n])
            }
            for (n = t.length - 1; n >= 0; n--) {
                this._expandBounds(t[n])
            }
        },
                    ...
                    for (i = t - 1; i <= t + 1; i++) {
                        ...
                        if (u) {
                            for (s = 0, a = u.length; s < a; s++) {
                                f = u[s];
                                l = this._sqDist(c[L.Util.stamp(f)], e);
                                if (l < h) {
                                    h = l;
                                    p = f
                                }
    ...
    (function() {
        L.QuickHull = {
            ...
            buildConvexHull: function(e, t) {
                ...
                if (r.maxPoint) {
                    n = n.concat(this.buildConvexHull([e[0], r.maxPoint], r.newPoints));
                    n = n.concat(this.buildConvexHull([r.maxPoint, e[1]], r.newPoints));
                    return n
                } else {
                    return [e[0]]
                }
    ...
    L.MarkerCluster.include({
        ...
        spiderfy: function() {
            ...
            if (e.length >= this._circleSpiralSwitchover) {
                i = this._generatePointsSpiral(e.length, r)
            } else {
                r.y += 10;
                i = this._generatePointsCircle(e.length, r)
            }
            this._animationSpiderfy(e, i)
        },
        ...
        _generatePointsCircle: function(e, t) {
            ...
            s.length = e;
            for (o = e - 1; o >= 0; o--) {
                u = this._circleStartAngle + o * i;
                s[o] = (new L.Point(t.x + r * Math.cos(u), t.y + r * Math.sin(u)))._round()
            }
            return s
        },
        _generatePointsSpiral: function(e, t) {
            var n = this._group.options.spiderfyDistanceMultiplier * this._spiralLengthStart,
                r = this._group.options.spiderfyDistanceMultiplier * this._spiralFootSeparation,
                i = this._group.options.spiderfyDistanceMultiplier * this._spiralLengthFactor,
                s = 0,
                o = [],
                u;
            o.length = e;
            for (u = e - 1; u >= 0; u--) {
                s += r / n + u * 5e-4;
                o[u] = (new L.Point(t.x + n * Math.cos(s), t.y + n * Math.sin(s)))._round();
                n += this._2PI * i / s
            }
            return o
        },
        _noanimationUnspiderfy: function() {
            ...
            for (s = r.length - 1; s >= 0; s--) {
                i = r[s];
                n.removeLayer(i);
                if (i._preSpiderfyLatlng) {
                    i.setLatLng(i._preSpiderfyLatlng);
                    delete i._preSpiderfyLatlng
                }
                if (i.setZIndexOffset) {
                    i.setZIndexOffset(0)
                }
                if (i._spiderLeg) {
                    t.removeLayer(i._spiderLeg);
                    delete i._spiderLeg
                }
            }
            e._spiderfied = null
    ...
    L.MarkerCluster.include(!L.DomUtil.TRANSITION ? {
        _animationSpiderfy: function(e, t) {
            var n = this._group,
                ...
                s, o, u, a;
            for (s = e.length - 1; s >= 0; s--) {
                a = r.layerPointToLatLng(t[s]);
                o = e[s];
                o._preSpiderfyLatlng = o._latlng;
                o.setLatLng(a);
                if (o.setZIndexOffset) {
                    o.setZIndexOffset(1e6)
                }
                i.addLayer(o);
                u = new L.Polyline([this._latlng, a], {
                    weight: 1.5,
                    color: "#222"
                });
                r.addLayer(u);
        ...
        SVG_ANIMATION: function() {
            return t.createElementNS("http://www.w3.org/2000/svg", "animate").toString().indexOf("SVGAnimate") > -1
        }(),
        _animationSpiderfy: function(e, n) {
            var r = this,
                i = this._group,
                s = i._map,
                o = i._featureGroup,
                u = s.latLngToLayerPoint(this._latlng),
                a, f, l, c;
            for (a = e.length - 1; a >= 0; a--) {
                f = e[a];
                if (f.setOpacity) {
                    f.setZIndexOffset(1e6);
                    f.setOpacity(0);
                    o.addLayer(f);
                    f._setPos(u)
                } else {
            ...
            var h = L.Path.SVG ? 0 : .3,
                p = L.Path.SVG_NS;
            for (a = e.length - 1; a >= 0; a--) {
                c = s.layerPointToLatLng(n[a]);
                f = e[a];
                f._preSpiderfyLatlng = f._latlng;
                f.setLatLng(c);
                if (f.setOpacity) {
                    f.setOpacity(1)
                }
                l = new L.Polyline([r._latlng, c], {
                    weight: 1.5,
                    color: "#222",
                    opacity: h
                });
                ...
                var d = l._path.getTotalLength();
                l._path.setAttribute("stroke-dasharray", d + "," + d);
                var v = t.createElementNS(p, "animate");
                v.setAttribute("attributeName", "stroke-dashoffset");
                v.setAttribute("begin", "indefinite");
                v.setAttribute("from", d);
                v.setAttribute("to", 0);
                v.setAttribute("dur", .25);
                l._path.appendChild(v);
                v.beginElement();
                v = t.createElementNS(p, "animate");
                v.setAttribute("attributeName", "stroke-opacity");
                v.setAttribute("attributeName", "stroke-opacity");
                v.setAttribute("begin", "indefinite");
                v.setAttribute("from", 0);
                v.setAttribute("to", .5);
                v.setAttribute("dur", .25);
                l._path.appendChild(v);
                v.beginElement()
            ...
            if (L.Path.SVG) {
                ...
                for (a = e.length - 1; a >= 0; a--) {
                    f = e[a]._spiderLeg;
                    f.options.opacity = .5;
                    f._path.setAttribute("stroke-opacity", .5)
                }
            }
            setTimeout(function() {
                i._animationEnd();
        ...
        _animationUnspiderfy: function(e) {
            var t = this._group,
                n = t._map,
                r = t._featureGroup,
                i = e ? n._latLngToNewLayerPoint(this._latlng, e.zoom, e.center) : n.latLngToLayerPoint(this._latlng),
                s = this.getAllChildMarkers(),
                o = L.Path.SVG && this.SVG_ANIMATION,
                u, a, f;
            t._animationStart();
            this.setOpacity(1);
            for (a = s.length - 1; a >= 0; a--) {
                u = s[a];
                if (!u._preSpiderfyLatlng) {
                    continue
                }
                ...
                if (u.setOpacity) {
                    ...
                    f = u._spiderLeg._path.childNodes[0];
                    f.setAttribute("to", f.getAttribute("from"));
                    f.setAttribute("from", 0);
                    f.beginElement();
                    f = u._spiderLeg._path.childNodes[1];
                    f.setAttribute("from", .5);
                    f.setAttribute("to", 0);
                    f.setAttribute("stroke-opacity", 0);
                    f.beginElement();
                    u._spiderLeg._path.setAttribute("stroke-opacity", 0)
                }
            }
            setTimeout(function() {
                var e = 0;
